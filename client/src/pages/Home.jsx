...
function Home() {
        ...
        setFinancialData({
          ...
          investments:
            investmentsResponse.data
              .map((investment) => investment.currentValue)
              .reduce((a, b) => a + b, 0) || 0,
  ...
  return (
    <section className="bg-gradient-to-r from-purple-200 to-blue-100 shadow-xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-gradient-to-r from-green-400 to-green-600 p-6 rounded-lg shadow-xl transform transition-transform hover:scale-105">
            ...
            <p className="text-3xl font-bold text-white mt-4">
              {formatCurrency(
                financialData.monthlyExpenses + financialData.investments
              )}
            </p>
