          ...
          <div className="glass-card p-8 md:p-10 shadow-2xl">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center px-4 py-3 border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-300 hover:shadow-md">
                  ...
                  <span className="ml-2 text-sm font-semibold text-slate-700">Google</span>
                </button>
                <button className="flex items-center justify-center px-4 py-3 border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-300 hover:shadow-md">
                  ...
                  <span className="ml-2 text-sm font-semibold text-slate-700">GitHub</span>
                </button>
              </div>
            </div>
          </div>
